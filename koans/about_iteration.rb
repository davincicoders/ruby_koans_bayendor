...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Adds an accumulater to the block initialized with a starting value
    # Reduces the need to initialize a variable before the iteration, and
    # then add another line to perform the operation.  Allows the array to
    # return the accumulator value directly.  It also mutates the array!
  end
